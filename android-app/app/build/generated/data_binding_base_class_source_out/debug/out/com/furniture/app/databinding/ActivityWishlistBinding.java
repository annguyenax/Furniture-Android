...
public final class ActivityWishlistBinding implements ViewBinding {
  ...
  private ActivityWishlistBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout emptyState,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvWishlist,
  ...
  public static ActivityWishlistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWishlistBinding((LinearLayout) rootView, emptyState, progressBar,
          rvWishlist, toolbar);
    }
