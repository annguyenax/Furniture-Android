...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button logoutButton,
      @NonNull RecyclerView productsRecyclerView, @NonNull ProgressBar progressBar,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, logoutButton, productsRecyclerView,
